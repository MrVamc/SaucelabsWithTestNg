...
public class firstNameErrorMssg extends newBaseclass{
	...
	public void verifyFirstNameErrorMssg(String firstname, String lastName, String zipCode) {
		...
		try {
			...
			Assert.assertEquals(check.getErrorMssg().getText(), check.firstNameErrorMssg, "Error message does not match");
